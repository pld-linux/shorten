...
%description -l pl
Shorten kompresuje pliki ze spróbkowanym d¼wiêkiem, takie jak RIFF
WAVE (.wav). Obs³ugiwana jest zarówno bezstratna jak i stratna
kompresja ze wspó³czynnikiem oko³o 2:1 w przypadku kompresji
